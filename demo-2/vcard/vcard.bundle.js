...
const cardData = {
  ...
  fullName: "Mira Solensen",               // Full name shown on the card and in vCard
  jobTitle: "Founder & Domestic Services Consultant",  // Job title under name and in vCard
  company: "Purespace Property Care Ltd",             // Company name shown on the card and in vCard
  ...
  // === Address ===
  address: "London, United Kingdom", // Full business address (shown + vCard ADR)

  // === Biography / About ===
  bio: "Purespace Property Care Ltd provides professional cleaning, light maintenance, and property support services for homeowners, tenants, landlords, and local agents.", // Short tagline (used in card + vCard NOTE)
  companyDescription: "We specialise in deep cleaning, end-of-tenancy preparations, one-off refreshes, and bespoke regular care plans to help homes look their absolute best.", // Optional long description (not in vCard)
  ...
  // === Footer Link ===
  footerTagline: "Your Trusted Partner in Home and Property Care.",
  footerCompanyUrl: "https://mycompany.com/", // URL of footer company link
  footerCompanyName: "Purespace Property Care Ltd",        // Link text for footer
  ...
  shareTitle: "Mira Solensen Digital Business Card", // Title used by Web Share API
