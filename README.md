...
Both demos use exactly the same template and functionality.
...
All editable content lives in `cardData.json`.
...
Social platforms do not execute JavaScript.
For correct link previews, update the following directly in `index.html`:

- `<title>`
- `<meta name="author">`
- `<meta name="description">`
- favicon and Apple touch icon links (absolute URLs)
...
Because of this, and because JSON is fetched, the project cannot be run via `file://`.
